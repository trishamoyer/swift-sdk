...
/**
   The IBM Watson Discovery Service is a cognitive search and content analytics engine that you can
...
public class Discovery {
    ...
    */
        ...
        success: @escaping (ListCollectionFieldsResponse) -> Void)
    {
        ...
        var queryParameters = [URLQueryItem]()
        queryParameters.append(URLQueryItem(name: "version", value: version))
        queryParameters.append(URLQueryItem(name: "collection_ids", value: collectionIds))
