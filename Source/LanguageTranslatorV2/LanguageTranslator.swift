...
public class LanguageTranslator {
    ...
    */
    ...
    /**
     ...
     - parameter baseModelID: The model ID of the model to use as the base for customization. To see available models, use the `List models` method.
     - parameter name: An optional model name that you can use to identify the model. Valid characters are letters, numbers, dashes, underscores, spaces and apostrophes. The maximum length is 32 characters.
     - parameter forcedGlossary: A TMX file with your customizations. The customizations in the file completely overwrite the domain translaton data, including high frequency or high confidence phrase translations. You can upload only one glossary with a file size less than 10 MB per call.
    ...
    */
    ...
    /**
     ...
     - parameter defaultModels: If the defaultModels parameter isn't specified, the service will return all models (defaultModels and non-defaultModels) for each language pair. To return only defaultModels models, set this to `true`. To return only non-defaultModels models, set this to `false`.
     - parameter failure: A function executed if an error occurs.
     - parameter success: A function executed with the successful result.
    */
